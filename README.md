...
[![Build](https://github.com/ballerina-platform/module-ballerinax-ai.memory.sqlite/actions/workflows/ci.yml/badge.svg)](https://github.com/ballerina-platform/module-ballerinax-ai.memory.sqlite/actions/workflows/ci.yml)
[![GitHub Last Commit](https://img.shields.io/github/last-commit/ballerina-platform/module-ballerinax-ai.memory.sqlite.svg)](https://github.com/ballerina-platform/module-ballerinax-ai.memory.sqlite/commits/main)
[![GitHub Issues](https://img.shields.io/github/issues/ballerina-platform/ballerina-library/module/ai.memory.sqlite.svg?label=Open%20Issues)](https://github.com/ballerina-platform/ballerina-library/labels/module%2Fai.memory.sqlite)
...
1. Import the `ballerinax/ai.memory.sqlite` module.

```ballerina
import ballerinax/ai.memory.sqlite;
```
...
2. Create the short-term memory store, by passing either the configuration for the database or a `jdbc:Client` client.
    ...
    import ballerina/ai;
    import ballerinax/java.jdbc;
    import ballerinax/ai.memory.sqlite as sqliteStore;
...
* For more information go to the [`ai.memory.sqlite` package](https://central.ballerina.io/ballerinax/ai.memory.sqlite/latest).
